...
19 September 2026. Research proposal, not an implemented benchmark or evidence of JEV performance. “NEV” in the request is provisionally interpreted as this project's JEV classifier.
...
Proceed if gains over the strongest baseline hold on untouched data, including the independent sample, at acceptable measured cost. No live inference, new dataset import, dependency change, or UI change was performed during this investigation.
