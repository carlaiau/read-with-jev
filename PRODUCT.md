...
- The reported initial mention baseline uses 12 development passages. It is neither JEV performance nor held-out evidence. No live JEV classification run has yet established model accuracy.
